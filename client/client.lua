...
local Il_Mio_Lavoro = "Disoccupato"

QBCore.Functions.TriggerCallback('Little_Core:GetJob', function(LAVORO_LITTLE_ITALY)
    Il_Mio_Lavoro = LAVORO_LITTLE_ITALY
end)

RegisterNetEvent('QBCore:Client:OnJobUpdate', function(JobInfo)
    Il_Mio_Lavoro = JobInfo.label
end)
    ...
    while true do
        ...
        if EGetConvarBool("els_developer") then
            ...
            if not NetworkIsSessionActive() then
                print("Non nella sessione di rete, la merda andrà a male in modo significativo, quindi ti stiamo impedendo di usare ELS.")
                ...
                if canControlELS then
                    ...
                    if vehN ~= 0 then
                        if (panelType == "original") then
                            ...
                            Draw("LCFRP", 0, 0, 0, 255, 0.745 + panelOffsetX, 0.825 + panelOffsetY, 0.25, 0.25, 1, true, 0)
                            Draw(Il_Mio_Lavoro, 0, 0, 0, 255, 0.92 + panelOffsetX, 0.825 + panelOffsetY, 0.25, 0.25, 1, true, 0)
                            ...
                            Draw("LUCE", 0, 0, 0, 255, 0.774 + panelOffsetX, 0.86 + panelOffsetY, 0.25, 0.25, 1, true, 0)
                            ...
                            Draw("LAMP", 0, 0, 0, 255, 0.806 + panelOffsetX, 0.86 + panelOffsetY, 0.25, 0.25, 1, true, 0)
                        ...
                        elseif panelType == "old" then
                            ...
                            Draw("LCFRP", 0, 0, 0, 255, 0.75, 0.93, 0.25, 0.25, 3, true, 0)
